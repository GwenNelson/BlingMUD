...
- [partly done: Ceridwen] Ceridwen's cottage, herb-garden rooms, and local FSM are present with bounded gated remedy/weed interactions. Rare Weed is now an explicit persisted template with one-at-a-time harvest and a bounded give-to-Ceridwen unlock; disorientation mechanics remain.
